...
class InputForm(Form):
	...
	dis = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	fru = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	apa = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	out = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	wit = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	...
	che = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	bre = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	...
	mus = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	ups = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	...
	abd = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	sub = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	med = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
	dra = RadioField(choices=[('Yes','Yes'),('No','No')], validators=[InputRequired()])
...
def index():
	...
	if form.validate_on_submit():
		array = [form.anx.data, form.dep.data, form.moo.data, form.res.data, form.mot.data, form.dis.data, form.fru.data, form.apa.data, form.out.data, form.wit.data, form.ind.data, form.foc.data, form.ove.data, form.irr.data, form.des.data, form.con.data, form.hig.data, form.nau.data, form.hea.data, form.che.data, form.bre.data, form.ble.data, form.slu.data, form.mus.data, form.ups.data, form.exh.data, form.fee.data, form.abd.data, form.sub.data, form.med.data, form.dra.data, form.isp.data, form.iep.data, form.exc.data, form.esc.data]
		print array
